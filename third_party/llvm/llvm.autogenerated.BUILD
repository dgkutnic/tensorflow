...
cc_library(
    ...
    copts = llvm_copts + ["-Iexternal/llvm-project-master/llvm/lib/Target/AArch64"],
    deps = [
        ":aarch64_desc",
        ":aarch64_info",
        ":aarch64_utils",
...
cc_library(
    ...
    copts = llvm_copts + ["-Iexternal/llvm-project-master/llvm/lib/Target/AMDGPU"],
    deps = [
        ":amdgpu_desc",
        ":amdgpu_info",
        ":amdgpu_utils",
...
cc_library(
    ...
    copts = llvm_copts + ["-Iexternal/llvm-project-master/llvm/lib/Target/ARC"],
    deps = [
        ":analysis",
        ":arc_desc",
        ":arc_info",
...
cc_library(
    ...
    copts = llvm_copts + ["-Iexternal/llvm-project-master/llvm/lib/Target/ARM"],
    deps = [
        ":arm_desc",
        ":arm_info",
        ":arm_utils",
...
cc_library(
    ...
    copts = llvm_copts + ["-Iexternal/llvm-project-master/llvm/lib/Target/AVR"],
    deps = [
        ":avr_desc",
        ":avr_info",
        ":config",
...
cc_library(
    ...
    copts = llvm_copts + ["-Iexternal/llvm-project-master/llvm/lib/Target/BPF"],
    deps = [
        ":bpf_desc",
        ":bpf_info",
        ":config",
...
cc_library(
    ...
    copts = llvm_copts + ["-Iexternal/llvm-project-master/llvm/lib/Target/Hexagon"],
    deps = [
        ":config",
        ":hexagon_desc",
        ":hexagon_info",
...
cc_library(
    ...
    copts = llvm_copts + ["-Iexternal/llvm-project-master/llvm/lib/Target/Lanai"],
    deps = [
        ":config",
        ":lanai_desc",
        ":lanai_info",
...
cc_library(
    ...
    copts = llvm_copts + ["-Iexternal/llvm-project-master/llvm/lib/Target/MSP430"],
    deps = [
        ":config",
        ":mc",
        ":mc_parser",
...
cc_library(
    ...
    copts = llvm_copts + ["-Iexternal/llvm-project-master/llvm/lib/Target/Mips"],
    deps = [
        ":config",
        ":mc",
        ":mc_parser",
...
cc_library(
    ...
    copts = llvm_copts + ["-Iexternal/llvm-project-master/llvm/lib/Target/NVPTX"],
    deps = [
        ":analysis",
        ":asm_printer",
        ":code_gen",
...
cc_library(
    ...
    copts = llvm_copts + ["-Iexternal/llvm-project-master/llvm/lib/Target/PowerPC"],
    deps = [
        ":config",
        ":mc",
        ":mc_parser",
...
cc_library(
    ...
    copts = llvm_copts + ["-Iexternal/llvm-project-master/llvm/lib/Target/RISCV"],
    deps = [
        ":config",
        ":mc",
        ":mc_parser",
...
cc_library(
    ...
    copts = llvm_copts + ["-Iexternal/llvm-project-master/llvm/lib/Target/Sparc"],
    deps = [
        ":config",
        ":mc",
        ":mc_parser",
...
cc_library(
    ...
    copts = llvm_copts + ["-Iexternal/llvm-project-master/llvm/lib/Target/SystemZ"],
    deps = [
        ":config",
        ":mc",
        ":mc_parser",
...
cc_library(
    ...
    copts = llvm_copts + ["-Iexternal/llvm-project-master/llvm/lib/Target/VE"],
    deps = [
        ":analysis",
        ":asm_printer",
        ":code_gen",
...
cc_library(
    ...
    copts = llvm_copts + ["-Iexternal/llvm-project-master/llvm/lib/Target/WebAssembly"],
    deps = [
        ":config",
        ":mc",
        ":mc_parser",
...
cc_library(
    ...
    copts = llvm_copts + ["-Iexternal/llvm-project-master/llvm/lib/Target/X86"],
    deps = [
        ":config",
        ":mc",
        ":mc_parser",
...
cc_library(
    ...
    copts = llvm_copts + ["-Iexternal/llvm-project-master/llvm/lib/Target/XCore"],
    deps = [
        ":analysis",
        ":asm_printer",
        ":code_gen",
