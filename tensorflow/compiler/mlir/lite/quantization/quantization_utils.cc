...
#include "mlir/Dialect/Quant/FakeQuantSupport.h"  // from @llvm-project-master
#include "mlir/Dialect/Quant/QuantOps.h"  // from @llvm-project-master
#include "mlir/Dialect/Quant/QuantTypes.h"  // from @llvm-project-master
#include "mlir/Dialect/Quant/QuantizeUtils.h"  // from @llvm-project-master
#include "mlir/Dialect/Quant/UniformSupport.h"  // from @llvm-project-master
