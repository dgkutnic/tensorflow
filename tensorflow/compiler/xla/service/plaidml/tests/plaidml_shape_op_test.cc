...
#include "tensorflow/compiler/xla/service/plaidml/tests/plaidml_shape_op_test.h.inc"
...
class PlaidMLShapeOperationTest
    : public PlaidMLCodegenTest,
      public ::testing::WithParamInterface<ShapeTestSpec> {
 protected:
...
INSTANTIATE_TEST_CASE_P(All,
                         PlaidMLShapeOperationTest,
                         ::testing::ValuesIn(GetShapeTestCases()),
