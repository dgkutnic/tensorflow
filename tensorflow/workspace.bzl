...
def tf_repositories(path_prefix = "", tf_repo_name = ""):
    ...
    tf_http_archive(
        ...
        additional_build_files = {
            ...
            clean_dep("@com_intel_plaidml//vendor/llvm:llvm.BUILD"): "llvm/BUILD",
            "@com_intel_plaidml//vendor/mlir:mlir.BUILD": "mlir/BUILD",
            "@com_intel_plaidml//vendor/mlir:test.BUILD": "mlir/test/BUILD",
        },
    )
